...
![Use case](./images/history-stack/use-case.jpg)
...
![Stack Model](./images/history-stack/stack-model.jpg)
...
![History Stack Model](./images/history-stack/history-stack-model.jpg)
...
![history stack demo](./images/history-stack/history-stack-demo.png)

![history stack demo code ](./images/history-stack/history-stack-demo-code.png)

所以如果我依序點擊 first 、second 、 third 按鈕之後，應該會在瀏覽器歷史裡新增三筆紀錄堆疊。

![history stack demo](./images/history-stack/history-stack-demo-result1.png)
...
![history stack demo push back](./images/history-stack/history-stack-demo-lastPage.png)
